...
print("-------------------------------------------------")
# Definire una classe abbonamento che abbia come attributi: "nome, prezo_menisle, mesi". Abbonamento dovrà avere un metodo
...
#Dovremmo prevedere la possibilità di definire entità che modellano i prodotti,
